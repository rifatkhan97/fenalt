...
export default function KnitwearManufacturingBangladeshPage() {
  const serviceJsonLd = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "High-End Knitwear Manufacturing Bangladesh",
    "provider": {
      "@type": "Organization",
      "name": "Fenalt",
    ...
    "description":
      "High-end circular and flatbed knitwear manufacturing in Dhaka, Bangladesh. Fine gauge 12GG/14GG cotton knits, 7GG heavy sweaters, French Terry fleece, and managed QC.",
  };
  ...
  const faqs = [
    {
      q: "What knitwear gauges can Fenalt produce in Bangladesh?",
      a: "We manage 5GG and 7GG chunky heavy knits, 12GG medium gauge sweaters, and 14GG/16GG fine gauge circular cotton knits.",
    },
    {
      q: "Can Fenalt source organic cotton yarns for knitwear?",
      a: "Yes. We source 100% combed organic cotton yarns, blended cotton-cashmere yarns, and circular deadstock yarns in Dhaka.",
    },
  ];
      ...
      <section className="pt-32 pb-20 lg:pt-44 lg:pb-28 bg-[#F2EFE9] relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
          ...
          <p className="text-lg lg:text-xl text-[#6B6560] leading-relaxed max-w-2xl mb-12">
            Engineered for soft hand-feel and dimensional stability. Produce fine gauge 12GG/14GG cotton sweaters, heavy 7GG cardigans, and French Terry fleece tops starting from 50 units.
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            >
              Start Knitwear Project <ArrowRight size={16} />
            </Link>
            <Link
              href="/capabilities"
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="max-w-3xl">
            <p className="text-xs font-semibold uppercase tracking-[0.25em] text-[#C8A882] mb-4">
              Dhaka Knitwear Heritage
            </p>
            <h2 className="font-display text-3xl lg:text-5xl font-light text-[#1A1A1A] mb-8">
              Precision Circular &amp; Flatbed Knitting
            </h2>
            <div className="space-y-6 text-[#6B6560] text-base lg:text-lg leading-relaxed">
              <p>
                Knitwear production requires rigorous yarn tension control, pre-shrunk wash treatments, and accurate linking to prevent seam torque or neck ribbing sag over time.
              </p>
              <p>
                <strong>Fenalt delivers luxury knitwear manufacturing:</strong> Our Dhaka operational team oversees yarn selection, gauge setup on automated Stoll and Shima Seiki machinery, linking audits, and pre-wash shrinkage testing.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {[
              {
                icon: Layers,
                title: "12GG & 14GG Fine Gauge",
                tag: "Light Sweaters",
                body: "Combed cotton and yarn-dyed fine knits for refined layering pieces and polished cardigans.",
              },
              {
                icon: Sparkles,
                title: "5GG & 7GG Chunky Sweaters",
                tag: "Heavy Knit",
                body: "Heavyweight 100% cotton crewnecks, mock necks, and waffle knit tops.",
              },
              {
                icon: Scissors,
                title: "Fully Fashioned Linking",
                tag: "Clean Seams",
                body: "Precision point-to-point linking for flat armholes and durable collar attachment.",
              },
            ].map((item, i) => {
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h2 className="font-display text-4xl lg:text-6xl font-light text-[#FAF9F6] mb-8">
              Pre-Shrinkage &amp; Seam Linking Audits
            </h2>
            <p className="text-lg text-[#E5DDD3] leading-relaxed font-light mb-8">
              We physically test yarn tension, shrinkage after laundering, and neck opening measurements before export.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-12">
            {[
              { title: "Measurement Tolerance (±1.5cm)", desc: "Strict sizing curve control across all knitwear sizes." },
      ...
      <section className="py-20 lg:py-24 bg-[#FAF9F6] border-t border-[#E5DDD3]">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <h2 className="font-display text-4xl lg:text-5xl font-light text-[#1A1A1A] mb-6">
            Manufacture high-end custom knitwear
          </h2>
          <p className="text-[#6B6560] leading-relaxed text-base lg:text-lg mb-10 max-w-xl mx-auto">
            Submit your knitwear tech pack or yarn specs for an all-inclusive quote within 24–48 hours.
          </p>
          <Link
            href="/intake"
          ...
          >
            Start Knitwear Order <ArrowRight size={16} />
          </Link>
        </div>
      </section>
    </>
