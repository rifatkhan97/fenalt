...
import { ArrowRight, ShieldCheck, Factory, Clock, Layers } from "lucide-react";
...
export default function ApparelProductionManagementPage() {
  const serviceJsonLd = {
    ...
    "@type": "Service",
    "name": "Apparel Production Management Services",
    "provider": {
      "@type": "Organization",
      "name": "Fenalt",
    ...
    "description":
      "Full-service clothing production management in Dhaka, Bangladesh. Micro-factory coordination, raw material tracking, in-line QC floor inspections, and door-to-door DDP logistics.",
  };
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Our Dhaka project team provides structured milestone reports across fabric arrival, cutting, line assembly, and final carton packing.",
    },
  ];
      ...
      <section className="pt-32 pb-20 lg:pt-44 lg:pb-28 bg-[#F2EFE9] relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
          ...
          <h1 className="font-display text-5xl sm:text-6xl lg:text-8xl font-light text-[#1A1A1A] leading-[1.05] max-w-5xl mb-8">
            Apparel Production Management for{" "}
            <span className="italic font-medium text-[#2D5016]">Growing Brands.</span>
          </h1>
          <p className="text-lg lg:text-xl text-[#6B6560] leading-relaxed max-w-2xl mb-12">
            Complete operational oversight from fabric roll to warehouse door. Fenalt manages micro-factory line scheduling, in-line quality control, and DDP export logistics on the ground in Dhaka.
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            >
              Start Managed Production <ArrowRight size={16} />
            </Link>
            <Link
              href="/operations"
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h2 className="font-display text-3xl lg:text-5xl font-light text-[#1A1A1A] mb-8">
              Eliminating Supply Chain Friction
            </h2>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {[
              {
                icon: Factory,
                title: "Factory Line Allocation",
                tag: "Scheduling",
                body: "Matching order quantities with audited micro-factories to guarantee production capacity and timeline commitments.",
              },
              {
                icon: Clock,
                title: "4–6 Week Bulk Production",
                tag: "Timeline Control",
                body: "Monitoring raw material arrival, cutting schedules, sewing output, and washing timelines.",
              },
              {
                icon: Layers,
                title: "Landed Freight & Customs",
                tag: "DDP Logistics",
                body: "Managing export documentation, customs duty filing, and door-to-door delivery.",
              },
            ].map((item, i) => {
      ...
      <section className="py-20 lg:py-24 bg-[#FAF9F6] border-t border-[#E5DDD3]">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <h2 className="font-display text-4xl lg:text-5xl font-light text-[#1A1A1A] mb-6">
            Let Fenalt manage your next production run
          </h2>
          <p className="text-[#6B6560] leading-relaxed text-base lg:text-lg mb-10 max-w-xl mx-auto">
            Submit your apparel tech packs or design specs for a fully managed quote within 24–48 hours.
          </p>
          <Link
            href="/intake"
          ...
          >
            Start Production Project <ArrowRight size={16} />
          </Link>
        </div>
      </section>
    </>
