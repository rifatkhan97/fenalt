    ...
    <>
      ...
      <section className="py-20 lg:py-28 bg-[#F2EFE9]">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <h2 className="font-display text-3xl lg:text-5xl font-light text-[#1A1A1A] mb-12">3 Pattern Making Techniques</h2>
          <div className="space-y-6">
            {methods.map((m, i) => (
              <div key={i} className="p-8 bg-[#FAF9F6] border border-[#E5DDD3]">
                <h3 className="font-display text-xl font-medium text-[#1A1A1A] mb-2">{m.name}</h3>
