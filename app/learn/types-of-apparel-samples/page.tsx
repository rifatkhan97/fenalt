    ...
    <>
      ...
      <section className="py-20 lg:py-28 bg-[#F2EFE9]">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <h2 className="font-display text-3xl lg:text-5xl font-light text-[#1A1A1A] mb-12">7 Essential Garment Samples</h2>
          <div className="space-y-6">
            {sampleTypes.map((st, i) => (
              <div key={i} className="p-8 bg-[#FAF9F6] border border-[#E5DDD3]">
                ...
                <p className="text-sm text-[#6B6560] leading-relaxed">{st.purpose}</p>
              </div>
            ))}
          </div>
        </div>
