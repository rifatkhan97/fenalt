    ...
    <>
      ...
      <section className="py-20 lg:py-28 bg-[#1A1A1A] text-[#FAF9F6]">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <h2 className="font-display text-3xl lg:text-5xl font-light text-[#FAF9F6] mb-12">Print Technology Breakdown</h2>
              ...
              <div key={i} className="p-6 bg-[#262626] border border-[#333333]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="p-4 bg-[#F2EFE9] border border-[#E5DDD3]">
                    ...
                    <p className="text-xs text-[#E5DDD3] leading-relaxed">{cp.screen}</p>
                  </div>
                  <div className="p-4 bg-[#F2EFE9] border border-[#E5DDD3]">
                    <span className="text-xs font-semibold text-[#C8A882] uppercase tracking-wider block mb-1">Direct-to-Garment (DTG)</span>
                    <p className="text-xs text-[#E5DDD3] leading-relaxed">{cp.dtg}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="py-20 bg-[#FAF9F6] border-t border-[#E5DDD3]">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <h2 className="font-display text-3xl lg:text-5xl font-light text-[#1A1A1A] mb-4">Industrial screen printing facilities</h2>
