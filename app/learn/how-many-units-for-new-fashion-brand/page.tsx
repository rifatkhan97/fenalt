    ...
    <>
      ...
      <section className="py-20 lg:py-28 bg-[#1A1A1A] text-[#FAF9F6]">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <h2 className="font-display text-3xl lg:text-5xl font-light text-[#FAF9F6] mb-12">Recommended Initial Volumes</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {benchmarks.map((bm, i) => (
              <div key={i} className="p-6 bg-[#262626] border border-[#333333]">
                <div className="w-8 h-8 rounded-full bg-[#2D5016] text-[#FAF9F6] flex items-center justify-center mb-4 text-xs font-bold">✓</div>
                <span className="text-xs font-semibold uppercase tracking-wider text-[#C8A882] block mb-2">{bm.label}</span>
                <h3 className="font-display text-2xl font-light text-[#FAF9F6] mb-2">{bm.range}</h3>
                <p className="text-sm text-[#E5DDD3] leading-relaxed"><strong className="text-[#1A1A1A]">Best for:</strong> {bm.bestFor}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-[#FAF9F6] border-t border-[#E5DDD3]">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <h2 className="font-display text-3xl lg:text-5xl font-light text-[#1A1A1A] mb-4">Start with flexible low MOQs</h2>
