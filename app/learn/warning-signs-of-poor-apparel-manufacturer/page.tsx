    ...
    <>
      ...
      <section className="py-20 lg:py-28 bg-[#F2EFE9]">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <h2 className="font-display text-3xl lg:text-5xl font-light text-[#1A1A1A] mb-12">4 Major Factory Red Flags</h2>
          <div className="space-y-6">
            {redFlags.map((rf, i) => (
              <div key={i} className="p-8 bg-[#FAF9F6] border border-[#E5DDD3]">
                <h3 className="font-display text-xl font-medium text-[#1A1A1A] mb-2">{rf.title}</h3>
                <p className="text-sm text-[#6B6560] leading-relaxed">{rf.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-[#1A1A1A]">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <h2 className="font-display text-3xl lg:text-5xl font-light text-[#FAF9F6] mb-4">Vetted, compliant manufacturing</h2>
