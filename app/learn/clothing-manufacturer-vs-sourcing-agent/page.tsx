...
export default function ManufacturerVsSourcingAgentPage() {
  ...
  const comparison = [
    ...
    {
      aspect: "Cost",
      manufacturer: "Lower cost per unit (no agent fee), but more management time and expertise required from the brand team.",
    ...
    {
      aspect: "Best For",
      manufacturer: "Established brands with experienced in-house sourcing teams, strong technical knowledge, and high-volume orders that justify direct factory management.",
      agent: "Startups, independent brands, and brands new to a particular manufacturing country who need local expertise and oversight without building it internally.",
    },
  ];
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Yes. Direct factory relationships are common for high-volume established brands with in-house production expertise. However, without on-the-ground oversight, brands typically have limited visibility into actual production conditions, quality issues, or timeline slippage until problems have already occurred. The cost of a QC failure discovered after export is almost always higher than the management fee of a professional production partner.",
    },
    {
    ...
    },
    {
      ...
      a: "Unverified or unscrupulous agents can misrepresent the factories they work with, sub-contract to unaudited facilities, mark up pricing without disclosure, or disappear after collecting an advance. Risk mitigation: verify physical presence in the manufacturing country, request video calls from the factory floor, ask for verifiable brand references, and never pay 100% upfront before production is underway.",
    },
    {
      q: "Does using a sourcing agent guarantee better quality than going direct to a factory?",
      a: "Not automatically. Agent quality varies as much as factory quality. A strong agent who provides genuine factory-floor oversight, in-line QC, and consistent pre-shipment inspection will typically improve quality outcomes compared to an unsupported direct factory relationship. A weak agent who operates purely as a middleman without real oversight may add cost without adding value. The agent's QC methodology is the critical differentiating factor.",
    },
  ];
    ...
    <>
      ...
      <section className="py-20 lg:py-28 bg-[#FAF9F6]">
        <div className="max-w-5xl mx-auto px-6 lg:px-8">
          ...
          <h2 className="font-display text-3xl lg:text-5xl font-light text-[#1A1A1A] mb-4">Direct Manufacturer vs Sourcing Agent</h2>
          <p className="text-base text-[#6B6560] leading-relaxed mb-10 max-w-2xl">
            Both approaches work for brands at the right stage of development. The decision depends on your in-house expertise, volume, and appetite for production management complexity.
          </p>
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-6 bg-[#262626] border border-[#333333]">
              ...
              <ul className="space-y-3">
                {[
                  ...
                  "Your order volumes are high enough to command factory attention and priority",
                  "You can travel to inspect factories personally or deploy a trusted QC agent",
                  "You are fluent in factory technical communication (tech packs, POM sheets, AQL)",
                  "You want full visibility into pricing without intermediary markup",
                ].map((item, i) => (
            ...
            <div className="p-6 bg-[#262626] border border-[#333333]">
              ...
              <ul className="space-y-3">
                {[
                  "You are launching a first or early collection without a production team",
                  "You have no existing contacts in Bangladesh or your target country",
                  "You need lower-MOQ access and factory flexibility",
                  "Consistent quality oversight on-the-ground is a priority",
                  "You want to reduce the communication and production management burden",
                  "You are not able to travel to the manufacturing country to inspect directly",
                ].map((item, i) => (
                  <li key={i} className="flex items-start gap-2 text-sm text-[#E5DDD3]">
                    <span className="text-[#C8A882] mt-0.5">✓</span> {item}
                  </li>
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              ...
              { href: "/learn/direct-manufacturer-vs-sourcing-agent", label: "Direct Manufacturer vs Sourcing Agent (In-Depth)" },
