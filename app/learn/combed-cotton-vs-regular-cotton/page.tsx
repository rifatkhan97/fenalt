    ...
    <>
      ...
      <section className="py-20 lg:py-28 bg-[#1A1A1A] text-[#FAF9F6]">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <h2 className="font-display text-3xl lg:text-5xl font-light text-[#FAF9F6] mb-12">Yarn Quality Differences</h2>
              ...
              <div key={i} className="p-6 bg-[#262626] border border-[#333333]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="p-4 bg-[#F2EFE9] border border-[#E5DDD3]">
                    <span className="text-xs font-semibold text-[#C8A882] uppercase tracking-wider block mb-1">Combed Cotton</span>
                    <p className="text-xs text-[#E5DDD3] leading-relaxed">{p.combed}</p>
                  </div>
                  <div className="p-4 bg-[#F2EFE9] border border-[#E5DDD3]">
                    <span className="text-xs font-semibold text-[#C8A882] uppercase tracking-wider block mb-1">Regular Carded Cotton</span>
                    <p className="text-xs text-[#E5DDD3] leading-relaxed">{p.regular}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="py-20 bg-[#FAF9F6] border-t border-[#E5DDD3]">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <h2 className="font-display text-3xl lg:text-5xl font-light text-[#1A1A1A] mb-4">Source 100% combed cotton knits</h2>
