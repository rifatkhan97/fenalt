    ...
    <>
      ...
      <section className="py-20 lg:py-28 bg-[#F2EFE9]">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <h2 className="font-display text-3xl lg:text-5xl font-light text-[#1A1A1A] mb-12">Operational Differences</h2>
              ...
              <div key={i} className="p-8 bg-[#FAF9F6] border border-[#E5DDD3]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="p-4 bg-[#F2EFE9] border border-[#E5DDD3]">
                    <span className="text-xs font-semibold text-[#2D5016] uppercase tracking-wider block mb-1">Fit Sample</span>
                    <p className="text-xs text-[#6B6560] leading-relaxed">{cp.fit}</p>
                  </div>
                  <div className="p-4 bg-[#F2EFE9] border border-[#E5DDD3]">
                    <span className="text-xs font-semibold text-[#C8A882] uppercase tracking-wider block mb-1">Pre-Production (PP) Sample</span>
                    <p className="text-xs text-[#6B6560] leading-relaxed">{cp.pp}</p>
                  </div>
                </div>
              </div>
            ))}
