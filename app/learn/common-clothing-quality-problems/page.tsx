    ...
    <>
      ...
      <section className="py-20 lg:py-28 bg-[#F2EFE9]">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <h2 className="font-display text-3xl lg:text-5xl font-light text-[#1A1A1A] mb-12">4 Major Apparel Defects &amp; Solutions</h2>
          <div className="space-y-6">
            {defects.map((d, i) => (
              <div key={i} className="p-8 bg-[#FAF9F6] border border-[#E5DDD3]">
                <h3 className="font-display text-xl font-medium text-[#1A1A1A] mb-2">{d.name}</h3>
                <p className="text-sm text-[#6B6560] leading-relaxed mb-2"><strong className="text-[#C8A882]">Root Cause:</strong> {d.cause}</p>
                <p className="text-sm text-[#6B6560] leading-relaxed"><strong className="text-[#2D5016]">Preventive Fix:</strong> {d.fix}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-[#1A1A1A]">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <h2 className="font-display text-3xl lg:text-5xl font-light text-[#FAF9F6] mb-4">Eliminate manufacturing defects</h2>
