    ...
    <>
      ...
      <section className="py-20 lg:py-28 bg-[#F2EFE9]">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <h2 className="font-display text-3xl lg:text-5xl font-light text-[#1A1A1A] mb-12">6 Common Cotton Fabrics</h2>
          <div className="space-y-6">
            {fabricTypes.map((ft, i) => (
              <div key={i} className="p-8 bg-[#FAF9F6] border border-[#E5DDD3]">
                <div className="flex items-center justify-between mb-2">
                  <h3 className="font-display text-xl font-medium text-[#1A1A1A]">{ft.name}</h3>
                  <span className="text-xs font-semibold text-[#2D5016] uppercase tracking-wider">{ft.category}</span>
                </div>
                <p className="text-sm text-[#6B6560] leading-relaxed">{ft.bestFor}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-[#1A1A1A]">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <h2 className="font-display text-3xl lg:text-5xl font-light text-[#FAF9F6] mb-4">Source premium cotton knits</h2>
