    ...
    <>
      ...
      <section className="py-20 lg:py-28 bg-[#F2EFE9]">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <h2 className="font-display text-3xl lg:text-5xl font-light text-[#1A1A1A] mb-12">Core Operational Differences</h2>
              ...
              <div key={i} className="p-8 bg-[#FAF9F6] border border-[#E5DDD3]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="p-4 bg-[#F2EFE9] border border-[#E5DDD3]">
                    <span className="text-xs font-semibold text-[#2D5016] uppercase tracking-wider block mb-1">Tech Pack</span>
                    <p className="text-xs text-[#6B6560] leading-relaxed">{c.techPack}</p>
                  </div>
                  <div className="p-4 bg-[#F2EFE9] border border-[#E5DDD3]">
                    <span className="text-xs font-semibold text-[#C8A882] uppercase tracking-wider block mb-1">Sewing Pattern</span>
                    <p className="text-xs text-[#6B6560] leading-relaxed">{c.pattern}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="py-20 bg-[#1A1A1A]">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <h2 className="font-display text-3xl lg:text-5xl font-light text-[#FAF9F6] mb-4">Complete tech pack &amp; pattern solutions</h2>
