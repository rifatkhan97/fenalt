...
export default function AustraliaCanadaApparelImportGuidePage() {
  const articleJsonLd = {
  ...
  const faqs = [
    {
      q: "Do Australian and Canadian apparel imports from Bangladesh qualify for preferential tariffs?",
      a: "Yes. Both Australia and Canada offer preferential duty-free or reduced tariff treatment for qualifying garments manufactured in Bangladesh when accompanied by valid Certificates of Origin.",
    },
    {
      ...
      <section className="pt-32 pb-20 lg:pt-44 lg:pb-28 bg-[#F2EFE9] relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
          ...
          <h1 className="font-display text-5xl sm:text-6xl lg:text-8xl font-light text-[#1A1A1A] leading-[1.05] max-w-5xl mb-8">
            Australia &amp; Canada Apparel Import:{" "}
          ...
          <p className="text-lg lg:text-xl text-[#6B6560] leading-relaxed max-w-2xl mb-12">
            A comprehensive guide for Australian and Canadian apparel brands importing clothing from Bangladesh. Learn how preferential tariff access and DDP landed freight optimize brand margins.
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            >
              Get Landed Quote <ArrowRight size={16} />
            </Link>
            <Link
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                tag: "Customs Entry",
                body: "Issued directly in Dhaka to satisfy Australian Border Force and Canada Border Services Agency requirements.",
              },
              {
                icon: CheckCircle2,
                title: "Door-to-Door DDP Freight",
                tag: "Landed Cost",
                body: "Fenalt manages international ocean/air freight, customs entry clearance, and local warehouse delivery.",
              },
            ].map((item, i) => {
      ...
      <section className="py-20 lg:py-24 bg-[#FAF9F6] border-t border-[#E5DDD3]">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <h2 className="font-display text-4xl lg:text-5xl font-light text-[#1A1A1A] mb-6">
            Import custom apparel to Australia or Canada
          </h2>
          <p className="text-[#6B6560] leading-relaxed text-base lg:text-lg mb-10 max-w-xl mx-auto">
            Submit your apparel specs for an all-inclusive landed quote within 24–48 hours.
          </p>
          <Link
            href="/intake"
          ...
          >
            Start AU/CA Import Project <ArrowRight size={16} />
          </Link>
        </div>
      </section>
    </>
