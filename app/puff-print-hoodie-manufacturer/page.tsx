...
export default function PuffPrintHoodieManufacturerPage() {
  const serviceJsonLd = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Puff Print Hoodie Manufacturing",
    "provider": {
      "@type": "Organization",
      "name": "Fenalt",
    ...
    "description":
      "Custom puff print hoodie production for streetwear brands. 380gsm–480gsm French Terry, boxy oversized patterns, 3D foam puff printing, and managed quality control in Dhaka.",
  };
  ...
  const faqs = [
    {
      q: "What puff print techniques does Fenalt use for hoodies?",
      a: "We utilize high-density plastisol foam inks calibrated for heat curing, creating durable 3D raised graphic prints that retain sharp edges after washing.",
    },
    {
      q: "What hoodie fabric weights are available for puff printing?",
      a: "We specialize in 380gsm, 420gsm, and 480gsm 100% cotton French Terry fleece and brushed fleece for heavy streetwear drape.",
    },
  ];
      ...
      <section className="pt-32 pb-20 lg:pt-44 lg:pb-28 bg-[#F2EFE9] relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
          <p className="text-xs font-semibold uppercase tracking-[0.25em] text-[#C8A882] mb-6">
            Streetwear Specialty
          </p>
          <h1 className="font-display text-5xl sm:text-6xl lg:text-8xl font-light text-[#1A1A1A] leading-[1.05] max-w-5xl mb-8">
            Puff Print Hoodie Manufacturer for{" "}
            <span className="italic font-medium text-[#2D5016]">Streetwear Labels.</span>
          </h1>
          <p className="text-lg lg:text-xl text-[#6B6560] leading-relaxed max-w-2xl mb-12">
            Engineered for high-impact streetwear graphics. We produce 380gsm–480gsm heavyweight fleece hoodies featuring durable 3D raised puff printing, custom dye lots, and 50-unit minimums.
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            >
              Start Puff Print Order <ArrowRight size={16} />
            </Link>
            <Link
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="max-w-3xl">
            <p className="text-xs font-semibold uppercase tracking-[0.25em] text-[#C8A882] mb-4">
              Puff Print Excellence
            </p>
            <h2 className="font-display text-3xl lg:text-5xl font-light text-[#1A1A1A] mb-8">
              Precision 3D Raised Printing
            </h2>
            <div className="space-y-6 text-[#6B6560] text-base lg:text-lg leading-relaxed">
              <p>
                Puff screen printing requires exact heat curing calibration. Inferior puff inks collapse, crack, or peel after wash cycles, ruining luxury streetwear drops.
              </p>
              <p>
                <strong>Fenalt delivers durable 3D puff graphics:</strong> Our Dhaka print technicians test foam ink viscosity and tunnel temperature settings to ensure high-rise puff graphics maintain structure and color intensity across every hoodie.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {[
              {
                icon: Sparkles,
                title: "3D High-Density Inks",
                tag: "High Rise",
                body: "Calibrated foam additives producing clean, raised 3D print edges that resist cracking.",
              },
              {
                icon: Layers,
                title: "380gsm–480gsm Fleece",
                tag: "Heavyweight",
                body: "100% combed cotton French Terry or plush brushed fleece for heavy structural drape.",
              },
              {
                icon: Scissors,
                title: "Custom Boxy Fits",
                tag: "Streetwear Cut",
                body: "Drop-shoulder silhouettes, double-layered hoods, and heavy 2x2 ribbing.",
              },
            ].map((item, i) => {
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h2 className="font-display text-4xl lg:text-6xl font-light text-[#FAF9F6] mb-8">
              Dhaka Print &amp; Sewing Supervision
            </h2>
            <p className="text-lg text-[#E5DDD3] leading-relaxed font-light mb-8">
              We physically audit print height, color fastness, and seam strength before garments are approved for export.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-12">
            {[
              { title: "Measurement Tolerance (±1.5cm)", desc: "Strict sizing curve control across all hoodies." },
      ...
      <section className="py-20 lg:py-24 bg-[#FAF9F6] border-t border-[#E5DDD3]">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <h2 className="font-display text-4xl lg:text-5xl font-light text-[#1A1A1A] mb-6">
            Produce high-impact puff print hoodies
          </h2>
          <p className="text-[#6B6560] leading-relaxed text-base lg:text-lg mb-10 max-w-xl mx-auto">
            Submit your graphic vector artwork and tech specs for an all-inclusive production quote within 24–48 hours.
          </p>
          <Link
            href="/intake"
